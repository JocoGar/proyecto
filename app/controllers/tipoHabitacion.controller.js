...
exports.create = (req, res) => {
    ...
    try {
        ...
        tipoHabitacion.precio_base = req.body.precio_base;
...
exports.updateById = async (req, res) => {
    try {
        ...
        if (!tipoHabitacion) {
            ...
            let result = await TipoHabitacion.update(updatedObject, { returning: true, where: { id_tipo_habitacion: tipoHabitacionId } });
